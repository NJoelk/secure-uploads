...
?>
<div class="updated"><p><strong><?php _e('Hooray!, You have secured your uploads! ', 'rl_process_done' ); ?></strong></p></div>
<?php
	...
	<form name="form1" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
		...
		<p class="submit">
		<input class="button-primary" type="submit" name="Submit" value="<?php _e('Secure your uploads now!', 'rl_secure_folder' ) ?>" />
		</p>
