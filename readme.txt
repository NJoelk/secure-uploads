...
== Description ==
This plugin will put blank index.php in every sub-directory of your wp-content/uploads folder to prevent people from stealing your content.
...
1. Screenshot of the plugins page

== Frequently Asked Questions ==

= Does this do every folder? =

Yes, the plugin will put the index.php in every folder under wp-content/uploads but it only does it when you click the "Secure uploads now!" button to start the process.
